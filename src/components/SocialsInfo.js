    ...
    <div className=" w-full h-[226px] md:h-[286px] mt-[40px] md:mt-[56px] mx-auto pt-[16px] md:pt-[26px] bg-[#EFEFEF]">
      <div className="w-full h-[117px] md:h-[148px] mb-[24px] md:mb-[44px] flex flex-row-reverse items-stretch justify-evenly">
        <div className=" h-[117px] md:h-[148px] w-[125px] md:w-[466px]">
          ...
          <p
            className="font-IranSans-medium text-[17px] md:text-[20px] mx-auto w-fit h-[27px] md:h-[31px] mt-[8px] "
            dir="rtl"
          >
            ۲۵ هزار
          </p>
          ...
          <p
            className="font-IranSans-Regular text-[11px] md:text-[13px] mx-auto w-fit mt-[8px] text-[#5D5D5D] "
            dir="rtl"
          >
            کاربر فعال
          </p>
      ...
      <button className="bg-[#E1165E] block w-[196px] h-[48px] md:w-[236px] md:h-[53px] rounded-[10px] mx-auto text-white font-IranSans-bold">
        دانلود اپلیکیشن
      </button>
    </div>
  );
